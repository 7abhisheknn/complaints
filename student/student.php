...
if (isset($_POST["submit1"])) {
    if ($_POST['choice'] == "Book") {
        ...
        header('Location:complaint_view_student.php');
    }
    else if ($_POST['choice'] == "all") {
        header('Location:complaint_view_all.php');
    }
}
?>
<!DOCTYPE html>
    ...
    <div>
        ...
        <div class="wrapper">
            <form id="form1" class="form" action="" method="post">
                ...
                <table>
                    <tr id="padding">
                        <td><a href="index3.html" target="_blank">
                                <div id="div1"><input type="radio" class="input button" value="Book" name="choice">
                                </div>
                            </a></td>
                        <td><a href="index2.html" target="_blank">
                                <div id="div2"><input type="radio" class="input button" value="View" name="choice">
                                </div>
                            </a></td>
                            <td><a href="index1.html" target="_blank"><div id="div3"><input type="radio" class="input button" value="all" name="choice"></div></a></td>
                           
                        <!-- <td><a href="index1.html" target="_blank"><div id="div3"><input type="radio" class="input button" value="complaint" name="login"></div></a></td> -->
                        <br>
                        <a href="#" class="ref2">Book complaint</a>
                        <a href="#" class="ref3">Preview complaints</a>
                        <a href="#" class="ref4">All</a>
                        <!-- <a href="#" class="ref4">complaint</a> -->
